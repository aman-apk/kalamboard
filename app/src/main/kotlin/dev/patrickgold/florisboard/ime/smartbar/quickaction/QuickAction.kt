...
fun QuickAction.computeDisplayName(evaluator: ComputingEvaluator): String {
    return when (this) {
        is QuickAction.InsertKey -> stringRes(when (data.code) {
            ...
            KeyCode.IME_UI_MODE_TRANSLATE -> R.string.quick_action__ime_ui_mode_translate
...
fun QuickAction.computeTooltip(evaluator: ComputingEvaluator): String {
    return when (this) {
        is QuickAction.InsertKey -> stringRes(when (data.code) {
            ...
            KeyCode.IME_UI_MODE_TRANSLATE -> R.string.quick_action__ime_ui_mode_translate__tooltip
